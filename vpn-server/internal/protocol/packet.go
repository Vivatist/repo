...
//
// Используем math/rand/v2 вместо crypto/rand: QUIC-заголовок не security-critical,
// его цель — маскировка для DPI. math/rand/v2 автоматически seed-ится от crypto/rand
